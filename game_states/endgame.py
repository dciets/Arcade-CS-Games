...
class EndGame:
    ...
    def run(self):
        ...
        if self.winner == -1:
            ...
            win_txt = self.game.font.render('The winner is : ' + self.game.players[self.winner].university +'!', 0, (255, 255, 255))
        ...
        for i in range(2):
            ...
            pts = self.game.font.render(txt, 0, (255, 0, 0) if i == 0 else (0, 0, 255))
            pts_rect = pts.get_rect()
            pts_rect.topleft = (50, 100*(i+1))
            new_score = self.game.font.render(txt2, 0, (255, 0, 0) if i == 0 else (0, 0, 255))
